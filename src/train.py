"""
Baseline Training Script for Medical AI Competition
Task: Transmission Image → FAX Fluorescence Image (Virtual Staining)
"""
...
class Config:
    ...
    # Image
    image_size = 512  # Resize from 1920x1440 to 512x512 for training
    in_channels = 1
    out_channels = 1
...
# ==============================================================================
# Simple U-Net (fallback if SMP not available)
# ==============================================================================
...
def quick_check(config):
    """Quick sanity check with minimal training."""
    config.epochs = 1
    config.batch_size = 2
